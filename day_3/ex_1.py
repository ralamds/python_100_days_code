...
43 does not have any decimal places. Therefore the division is clean. e.g. 59 is odd because 59 ÷ 2 = 29.5
...
n = int(input("What number you want to know if it is odd or even? "))
